...
const sortOptions = [
  ...
  { name: 'Price: Low to High', sort: 'price', oorder: 'asc', current: false },
  { name: 'Price: High to Low', sort: 'price', oorder: 'desc', current: false },
]
...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'huawai', label: 'huawei', checked: false },
